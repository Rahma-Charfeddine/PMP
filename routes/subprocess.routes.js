const {Create_subprocess, Get_subprocess_by_id, Get_all_subprocesses, Delete_subprocess_by_id,Update_subprocess_by_id } = require('../services/subprocess.services');
